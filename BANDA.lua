...
sudo_users = {SUDO,1827953514,1774315810}   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ᴊᴀʙᴡᴀ ˼',url="t.me/OSDDR"},{text = '˹ᴛᴀʜᴀ➧ᴏғғʟɪɴᴇ˼', url="t.me/Xxx_ksomk_xxX"}},
...
{{text = '˹توصل جابوا˼',url="t.me/TWASLJABWA"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[ 
[قناه سورس سون ادخل وتابع الجديد](t.me/S_a_i_d_i)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹ᴊᴏɪɴ➧ѕᴏᴏɴ˼', url="t.me/S_a_i_d_i"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qtdao/24&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/S_a_i_d_i"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[
╔━━━━━━━━✧━━━━━━━╗  
┇⦑[ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏụʀᴄᴇ ѕᴏᴏɴ](t.me/S_a_i_d_i)⦒
┇⦑[ᴛʜᴇ ʙᴇѕᴛ ѕᴏụʀᴄᴇ ɪɴ ᴛᴇʟᴇ](t.me/S_a_i_d_i)⦒
┇⦑[ᴠᴇʀʏ ᴘʀᴏᴛᴇᴄᴛᴇᴅ ѕᴏụʀᴄᴇ ѕᴏᴏɴ](t.me/S_a_i_d_i)⦒
╚━━━━━━━━✧━━━━━━━╝ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ 𝙹𝙰𝙱𝚆𝙰 ˼',url="t.me/OSDDR"},{text = '˹ᴛᴀʜᴀ➧ᴏғғʟɪɴᴇ˼', url="t.me/Xxx_ksomk_xxX"}},
{{text = '˹ʙᴀɴᴅᴀ➧ᴏғғʟɪɴᴇ˼', url="t.me/J_A_B_W_A"}},
{{text = '˹ᴊᴏɪɴ➧ѕᴏᴏɴ˼', url="t.me/S_a_i_d_i"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
usertext = '\n ☽ الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'S_a_i_d_i')..')'
status  = '\n ☽ تم حظرو عام من الجروبات '
texts = usertext..status
...
' }\n'..' ☽  الايدي بالصوره  ↚ { '..idph..
' }\n'..' ☽  الرفع  ↚ { '..setadd..
' }\n'..' ☽  الحظر  ↚ { '..banm..' }\n\n ☽ ⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺\n ☽ قناة سورس سون↓\n [ ❲[𝐒ΘΘ𝐍](t.me/S_a_i_d_i)❳](t.me/S_a_i_d_i) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/S_a_i_d_i)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🌚💕](t.me/S_a_i_d_i)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/S_a_i_d_i)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/S_a_i_d_i)')
return false
end
end
end
...
{
{text = '˹𝐣𝐨𝐢𝐧➧??𝐨𝐨𝐧˼', url="t.me/S_a_i_d_i"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
